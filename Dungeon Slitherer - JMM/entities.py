...
class Entity(pygame.sprite.Sprite):
    def __init__(self, type, x, y, image_width, image_height, entity_width, entity_height, display, extra_info):
        ...
        """
        self.image = self.create_image(os.path.join("Dungeon Slitherer - JMM", "assets", self.stored_image), self.stored_rotation, image_width, image_height, entity_width, entity_height)
