...
class SnakeHitbox(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        image_location = os.path.join("Dungeon Slitherer", "assets", "hitbox.png")
...
class SnakeBody(pygame.sprite.Sprite):
    def __init__(self, x, y, front_direction, back_direction):
        super().__init__()
        image_location = os.path.join("Dungeon Slitherer", "assets", "snake_body_straight.png")
        image_location_two = os.path.join("Dungeon Slitherer", "assets", "snake_body_corner.png")
        image_location_three = os.path.join("Dungeon Slitherer", "assets", "snake_body_end.png")
        image_location_four = os.path.join("Dungeon Slitherer", "assets", "snake_body_straight_hurt.png")
        image_location_five = os.path.join("Dungeon Slitherer", "assets", "snake_body_corner_hurt.png")
        image_location_six = os.path.join("Dungeon Slitherer", "assets", "snake_body_end_hurt.png")
...
class Snake(pygame.sprite.Sprite):
    def __init__(self, x, y, update_every, damage_time, limit):
        super().__init__()
        image_location = os.path.join("Dungeon Slitherer", "assets", "snake_head.png")
        image_location_two = os.path.join("Dungeon Slitherer", "assets", "snake_head_hurt.png")
